...
def train(args, seed): 
    ...
    evaluations = [eval_policy(policy, args.env, seed)]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--Nseed", default=int(0.5*multiprocessing.cpu_count()), type=int)          # Sets Gym, PyTorch and Numpy seeds
    ...
    np.save(f"./results/{file_name}", np.mean(evaluations,0))
    if args.save_model: 
