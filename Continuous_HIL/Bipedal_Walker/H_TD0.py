...
class H_TD0(object):
    def __init__(self, state_dim, action_dim, option_dim, termination_dim, max_action, l_rate_critic=3e-4, discount=0.99, tau=0.005, eta = 1e-7):
    ...
    def train(self, option, batch_size=256):
        ...
        with torch.no_grad():
            ...
            for option_i in range(self.option_dim):
                next_action, log_pi_next_state, _ = self.pi_lo[option_i].sample(next_state)
